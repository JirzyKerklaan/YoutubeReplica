...
<body>
                <div id='allComments' class="">
                    ...
                    $commSel = "SELECT comments.comment, user.username, user.ProfilePic FROM comments INNER JOIN user ON comments.AccountID = user.AccountID WHERE user.AccountID = $user";
